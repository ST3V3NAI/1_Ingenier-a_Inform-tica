...
int main() {
    // DISCLAIMIER: Take into account that identfiers should alwas be meaningful
    //              The use of identifiers with a single characater (i, p, etc.) is a Bad Practice
    //              Here we use identifiers for the sake of simplicity and to relate this code
