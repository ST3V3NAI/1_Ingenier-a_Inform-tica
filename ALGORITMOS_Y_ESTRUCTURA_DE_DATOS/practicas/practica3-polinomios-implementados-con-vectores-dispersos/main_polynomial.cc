...
int main() {
  // Llamamos a 3 Objetos de la clase Polynomial
  Polynomial p1, p2, p3;


  // Los imprimimos por pantalla los polinomios
  cin >> p1 >> p2 >> p3;
  cout << "p1= " << p1;
  cout << "p2= " << p2;
  cout << "p3= " << p3;
  cout << endl;
   ...
   // Fase II
   // Imprimos por pantalla los sparse vector
  ...
  // Fase III
  // Solicitamos por pantalla el valor de x1, x2, x3
  double x1, x2, x3;
  cin >> x1 >> x2 >> x3;
  // Evaluamos en x1, x2, x3 los polinomios
  ...
  // Evaluamos en x1, x2, x3 los sparse vector
  ...
  // Fase IV
  // Comprobamos si los resultados son iguales en los polinimios
  ...
  cout << endl;
    ...
    // Comprobamos si los resultados son iguales en los sparse vector
  ...
  // Comprobamos si los resultados son iguales en los sparse vector y los polinomios
  ...
  cout << endl;
   ...
   // Modificacion 
    cout << "AVG de los coef.de sp1 con grado impar: " << sp1.AverageOfOddDegreeCoeficients() << endl;
    cout << "AVG de los coef.de sp2 con grado impar: " << sp2.AverageOfOddDegreeCoeficients() << endl;
    cout << "AVG de los coef.de sp3 con grado impar: " << sp3.AverageOfOddDegreeCoeficients() << endl;
