...
int main()
{
  // Impresión de vectores densos o dispersos
  ...
  // Fase II
  // Impresión del polinomios sin los nulos
  ...
  // Fase III
  // Evaluación de polinomio en las x1, x2, x3
  double x1, x2, x3;
  cin >> x1 >> x2 >> x3;
  ...
  sllp3.IntercambiaSegundoConTercero(); 
  std::cout << sllp3 << std::endl; 
