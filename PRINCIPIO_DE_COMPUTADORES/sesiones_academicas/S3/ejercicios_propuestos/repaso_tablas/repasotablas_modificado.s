...
strX:		.asciiz " x "
strInterroga:	.asciiz " ? "
strSegundoIntento: .asciiz "Intentalo de nuevo"
...
if_resultado:
	mul	$t0,$s2,$s0
	beq	$s3,$t0, if_resultado_cumplido

	li  $v0,4
	la  $a0, strSegundoIntento
	syscall

	addi $s5, 1

	ble  $s5, 2, if_resultado_fin

if_resultado_cumplido: 
