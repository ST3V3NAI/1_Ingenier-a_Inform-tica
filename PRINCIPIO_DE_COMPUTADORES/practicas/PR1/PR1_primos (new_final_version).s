...
#         std::cin >> limite_inferior; 
        ...
        move $s0, $v0                   
if_while_true: 
        li $s6, 2                          # Iniclalizamos en $t0 = 2 y $t1 = 1000 
        li $s7, 1000                    
...
#        blt $s1, $t0, while_not_true_1  
#        blt $s1, $s0, while_not_true_1 
#        bgt $s1, $t1, while_not_true_1  
        j bucle_for                    
...
for_dentro_2:
        bge $t2, $s2, if_bucle_for_2_dentro
...
marcar_no_primo: 
        ...
        j siguiente_numero              # Salta a la siguiente ietracion para imprimir el siguinete numero
#             }
#         }
...
#             std::cout << parameter_i; 
        j siguiente_numero              # Saltar a la siguiente iteracion si no es primo
...
#     std::cout << "Fin del programa.\n"; 
        ...
        la $a0, cadFinDePrograma        # Llamada a la direccion de la cadena cadFinDePrograma
        syscall                         # llamada al sistema
#     return 0;
